...
function speak() {
  setTimeout(() => playByText("en-US", "welcom to my website"), 300);
}
...
async function conversationaAssistantAdd(response) {
  conversationHistory.push({ role: "assistant", content: response });
 updateChatContainer();
}
async function openai_test() {
  url = "https://api.openai.com/v1/chat/completions"; // This is the endpoint (location) of the GPT server
  let apikey1 = "sk";
